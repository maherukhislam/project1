...
import { Mail, Lock, Eye, EyeOff, Globe, ArrowRight, User } from 'lucide-react';
    ...
    <div className="min-h-screen flex items-center justify-center px-6 py-32">
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-slate-600">Start your journey to global education</p>
        </div>
        ...
        <GlassCard className="p-8" hover={false}>
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <label className="flex items-start gap-2 cursor-pointer">
              <input type="checkbox" className="w-4 h-4 mt-1 rounded border-slate-300 text-sky-500 focus:ring-sky-500" required />
